...
def test(KSTEPS=20):
    ...
    print("test time per sample: {}".format(ctime/float(step)))
    print("=================================================")
...
paths = ['./checkpoint/astgnn/*social-stgcnn*']
KSTEPS=20
...
for feta in range(len(paths)):
    ...
    for exp_path in exps:
        ...
        #Defining the model 
        model = ast_gnn(n_stgcnn =args.n_stgcnn,n_txpcnn=args.n_txpcnn,
